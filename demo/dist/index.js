(function(factory) {
  ...
  */
  ...
  function listen(options, handler) {
    var eventName = options.element === window ? "scroll" : "wheel";
      ...
      _createClass(WindowExample, [
        ...
        },
        {
          ...
          value: function render() {
            ...
            var btnName = this.state.dispose ? "Dispose" : "Register";
            var labelName = this.state.dispose
                  ...
                  react.createElement(
                    "button",
                    {
                      ...
                      onClick: function onClick() {
                        if (_this3.state.dispose) {
                          _this3.state.dispose();
